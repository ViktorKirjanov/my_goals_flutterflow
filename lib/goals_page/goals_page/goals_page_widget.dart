            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: FutureBuilder<List<GetGoalsRow>>(
                    future: SQLiteManager.instance.getGoals(),
                    builder: (context, snapshot) {
                      ...
                      final listViewGetGoalsRowList = snapshot.data!;
                      ...
                      return ListView.separated(
                        ...
                        itemCount: listViewGetGoalsRowList.length,
                        separatorBuilder: (_, __) => SizedBox(height: 12.0),
                        itemBuilder: (context, listViewIndex) {
                          final listViewGetGoalsRow =
                              listViewGetGoalsRowList[listViewIndex];
                          return InkWell(
                                  ...
                                  children: [
                                                  ...
                                                  child: Padding(
                                                    padding:
                                                        MediaQuery.viewInsetsOf(
                                                            context),
                                                    child:
                                                        EditGoalComponentWidget(
                                                      goalId:
                                                          listViewGetGoalsRow
                                                              .id,
                                                      title: listViewGetGoalsRow
                                                          .title,
                                                      description:
                                                          listViewGetGoalsRow
                                                              .description,
                                    ...
                                    Stack(
                                      ...
                                      children: [
                                        LinearPercentIndicator(
                                          percent: (int total, int completed) {
                                            return total != 0
                                                ? (completed / total) * 1.0
                                                : 0.0;
                                          }(
                                              listViewGetGoalsRow.totalTasks,
                                              listViewGetGoalsRow
                                                  .totalComplited),
                                          lineHeight: 5.0,
                                          animation: true,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            '${listViewGetGoalsRow.totalComplited.toString()}/${listViewGetGoalsRow.totalTasks.toString()}',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
