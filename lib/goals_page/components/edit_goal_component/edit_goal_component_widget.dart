...
import 'edit_goal_component_model.dart';
export 'edit_goal_component_model.dart';

class EditGoalComponentWidget extends StatefulWidget {
  const EditGoalComponentWidget({
    super.key,
  ...
  @override
  State<EditGoalComponentWidget> createState() =>
      _EditGoalComponentWidgetState();
}

class _EditGoalComponentWidgetState extends State<EditGoalComponentWidget> {
  late EditGoalComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditGoalComponentModel());
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            await SQLiteManager.instance.deleteGoal(
                        ...
                        Expanded(
                          child: FFButtonWidget(
                            onPressed: () async {
                              await SQLiteManager.instance.updateGoal(
                                goalId: widget.goalId!,
